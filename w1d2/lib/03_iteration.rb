...
# give back the substrings of an array
def substrings(string)
  subs = [] # holds the substrings
  # sub_start cycles through each letter in string
  string.length.times do |sub_start|
    # iterate through a range of sub_start to the end of the string
    ((sub_start)..(string.length-1)).each do |sub_end|
      substring = string[sub_start..sub_end]
...
class Array
  def my_each(&prc)
    ...
    self # returns the original array
  end
end
